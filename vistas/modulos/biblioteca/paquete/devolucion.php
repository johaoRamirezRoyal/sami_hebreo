...
$datos_devolucion = $instancia->mostrarUltimosDevolucionesControl();
                        ...
                        <table class="table table-hover border table-sm" width="100%" cellspacing="0">
                            ...
                            <tbody class="buscar">
                                ...
                                foreach ($datos_devolucion as $devolucion) {
                                    ...
                                    $nom_paquete      = $devolucion['nom_paquete'];
                                    $nom_usuario      = $devolucion['nom_user'];
                                    ...
                                    $devuelto         = $devolucion['id_devuelto'];
...
?>
<script src="<?=PUBLIC_PATH?>js/biblioteca/funcionesPaqueteDevolucion.js"></script>