                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button type="button" class="btn btn-hebreo btn-sm" data-tooltip="tooltip" data-placement="bottom" title="Ver usuario" data-toggle="modal" data-target="#editar_usuario<?=$id_user?>">
                                                        <i class="fa fa-search"></i>
                                                    </button>
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST" class="form_enviar_editar<?=$id_user?>">
                                                        ...
                                                        <div class="modal-header p-3">
                                                            <h4 class="modal-title text-hebreo font-weight-bold">Ver Usuario</h4>
                                                        </div>
                                                            ...
                                                            <div class="row  p-3">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control numeros" name="documento_edit" value="<?=$documento?>" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="font-weight-bold">Nombre <span class="text-danger">*</span></label>
                                                                        <input type="text" class="form-control letras"   name="nombre_edit" value="<?=$usuario['nombre']?>" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="font-weight-bold">Apellido</label>
                                                                        <input type="text" class="form-control letras"   name="apellido_edit" value="<?=$usuario['apellido']?>"disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="font-weight-bold">Telefono</label>
                                                                        <input type="text" class="form-control numeros"   name="telefono_edit" value="<?=$telefono?>" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="font-weight-bold">Correo <span class="text-danger">*</span></label>
                                                                        <input type="email" class="form-control"  name="correo_edit" value="<?=$correo?>"disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="font-weight-bold">Asignatura</label>
                                                                        <input type="text" class="form-control"   name="asignatura_edit" value="<?=$asignatura?>"disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                  ...
                                                                  <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="perfil_edit" disabled>
