...
if (isset($_POST['buscar'])) {
    $datos = array('buscar' => $_POST['buscar'], 'id_log' => $_POST['id_log'], 'fecha' => $_POST['fecha']);
    $datos_usuarios = $instancia->buscarUsuarioAsistenciaPersonalFiltroControl($datos);
} else {
    $datos_usuarios = $instancia->buscarUsuarioAsistenciaPersonalControl($id_log);
}
?>
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-hebreo btn-sm" type="submit" name="buscar">
                    ...
                    <table class="table table-hover border table-sm" width="100%" cellspacing="0">
                        ...
                        <tbody class="buscar">
                            ...
                            foreach ($datos_usuarios as $usuario) {
                                ...
                                // Convertimos hora a objeto DateTime para comparar
