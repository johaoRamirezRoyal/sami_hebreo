...
if (isset($_GET['detalle'])) {
    ...
    $id_detalle    = base64_decode($_GET['detalle']);
    $datos_detalle = $instancia->mostrarDatosDetallePaqueteControl($id_detalle);
    ...
    <body>
        <div class="container-fluid">
            <div class="row p-2" style="text-align: center;">
                <?php
                $codigo = $datos_detalle['codigo'];
                $img    = '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode($codigo, $generator::TYPE_CODE_128, 3, 81, $blackColor)) . '">';

                for ($i = 0; $i < 2; $i++) {
                    ?>
                    <div class="col-lg-4 p-2 form-group ml-2 text-center border mb-5" style="width: 40%; page-break-after: always;">
                        <?=$img?>
                        <h4><?=$codigo?></h4>
                    </div>
                    <br>
