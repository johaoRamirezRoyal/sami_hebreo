                                ...
                                foreach ($todos_usuarios as $usuario) {
                                    ...
                                    if ($estado == 'activo') {
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                              <div class="btn-group">
                                                  <a href="<?=BASE_URL?>enfermeria/atencion?usuario=<?=base64_encode($id_user)?>" class="btn btn-primary btn-sm" data-tooltip="tooltip" title="Atencion Medica" data-placement="bottom">
