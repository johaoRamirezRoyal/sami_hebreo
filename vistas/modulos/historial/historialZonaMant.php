...
if (isset($_POST['fecha_fin'])) {
	...
	$datos_historial = $instancia->buscarHistorialZonaMantControl($fecha_inicio, $fecha_fin, $zona);
} else {
	$datos_historial = $instancia->mostrarHistorialZonaMantControl();
}
			...
			<div class="card shadow-sm mb-4">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h4 class="m-0 font-weight-bold text-primary">
						<a href="<?=BASE_URL?>historial/historialZona" class="text-decoration-none">
							<i class="fa fa-arrow-left text-primary"></i>
						</a>
						&nbsp;
						Historial de reportes de zona (Mantenimientos)
					</h4>
				</div>
				<div class="card-body">
					<form method="POST">
										...
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title font-weight-bold text-primary" id="exampleModalLabel">Editar Mantenimiento No. <?=$id_historial?></h5>
												</div>
