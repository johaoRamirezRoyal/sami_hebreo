...
$isntancia_proveedor = ControlProveedor::singleton_proveedor();

$datos_usuarios = $isntancia_proveedor->mostrarTodosProveedoresControl();
				...
				<div class="card shadow-sm mb-4">
					...
					<form id="prefactura" method="POST">
						...
						<div class="card-body">
							...
							<div class="<?=$ver_cotizacion_aprobada?>">
								<div class="col-lg-12 form-group mt-4">
									<h5 class="font-weight-bold text-center text-hebreo text-uppercase">Cotizaciones / Ordenes Compradas</h5>
									<hr>
								</div>
								<div class="table-responsive mt-2">
									<table class="table border table-sm" width="100%" cellspacing="0">
										<thead>
											<tr class="text-center font-weight-bold">
												<th scope="col" class="w-50">Cotizacion / Orden de compra</th>
							...
							<div class="row p-2">
								...
								if (!empty($datos_solicitud['id_pedido'])) {
									...
									<div class="col-lg-4 form-group">
										...
										<input type="text" class="form-control" value="<?=$datos_solicitud['nom_pedido']?>" disabled>
									</div>
									<div class="col-lg-4 form-group">
										<label class="font-weight-bold">Proveedor a quien se realiza el pedido</label>
										<input type="text" class="form-control" value="<?=$datos_solicitud['nom_proveedor']?>" disabled>
									</div>
									<div class="col-lg-12 form-group">
